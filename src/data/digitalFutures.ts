    ...
    lessons: [
      {
        ...
        timing: {
          ...
          create: { mins: 38, task: 'Structured exploration: Students use Copilot (school-safe) to complete 4 mini-challenges. (1) Ask it to explain a topic they find confusing in school. Rate the explanation 1-5. (2) Ask it to write a poem about their hobby — edit it to make it actually theirs. (3) Ask it a local fact they know the answer to — catch it if it\'s wrong. (4) Ask it to help plan a birthday party — note what\'s useful and what\'s wrong. Document everything in their "AI Log" (template provided).', tools: ['Microsoft Copilot', 'AI Log template (Word Online)'] },
        ...
        teacherNote: 'Use school-approved AI tools only. Check your school policy before this lesson. If ChatGPT isn\'t approved, Microsoft Copilot is generally school-safe. Do not skip the safety rules — they matter.',
      },
      {
