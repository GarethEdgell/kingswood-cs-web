// Digital Futures â€” AI & Digital Skills Curriculum
...
export const DF_UNITS: DFUnit[] = [
...

  {
    ...
    colour: '#00d4ff', emoji: 'ðŸ—ï¸',
    lessons: [
      {
        id: 'df-8-1', year: 8, lessonNum: 1, unitNum: 1,
        title: 'Digital Me', subtitle: 'Set up your digital identity and portfolio',
        emoji: 'ðŸªª', colour: '#00d4ff',
        bigIdea: 'Everything you create this year lives in one organised place â€” let\'s build it.',
        objectives: [
        ...
        vocab: [
          ...
          { term: 'File format', def: 'The type of file, e.g. .docx, .pdf, .png â€” affects what can open it' },
        ],
        timing: {
          ...
          create: { mins: 40, task: 'Students: (1) Create their Digital Futures folder structure in OneDrive. (2) Complete the baseline skills audit Microsoft Forms (linked). (3) Create a "Digital Me" card in PowerPoint Online or Canva â€” name, three digital skills they already have, three they want to learn. Export to PDF and save in correct folder.', tools: ['OneDrive', 'PowerPoint Online', 'Canva', 'Microsoft Forms'] },
          share: { mins: 5, activity: 'Cold call 3 students: show me your folder on screen. Teacher ticks off checklist.' },
        },
        aiAngle: 'Not introduced yet â€” this lesson establishes the habits that make AI use safe and traceable.',
        tools: [
        ...
        differentiation: {
          support: 'Pre-made folder template shared via class link â€” students copy it rather than build from scratch',
        ...
        teacherNote: 'This lesson sets up habits for the whole year. Be strict on naming conventions now â€” it saves enormous time later. Check every student has cloud storage before lesson ends.',
      },
      {
        id: 'df-8-2', year: 8, lessonNum: 2, unitNum: 1,
        title: 'File Boss', subtitle: 'Master file management and cloud tools',
        emoji: 'ðŸ“', colour: '#00d4ff',
        ...
        vocab: [
          { term: 'Version history', def: 'A record of every change made to a file â€” you can roll back to any point' },
          { term: 'Export', def: 'Saving a file in a different format (e.g. .docx â†’ .pdf)' },
        ...
        timing: {
          hook: { mins: 5, activity: '"Has anyone ever lost a piece of homework?" Show a dramatic story of a student losing a whole essay. Then show version history saving the day â€” teacher demo on a Word Online.' },
          teach: { mins: 10, points: [
            ...
            'Sharing settings: view, comment, edit â€” why this matters',
        ...
        aiAngle: 'Files and version history are especially important when using AI â€” you need to track what YOU wrote vs. what AI helped with.',
        tools: [
          { name: 'OneDrive', url: 'https://onedrive.live.com', free: true },
      ...
      },
      {
        ...
        emoji: 'ðŸ“§', colour: '#00d4ff',
        bigIdea: 'How you write online creates an impression â€” make it a good one.',
        objectives: [
        ...
        vocab: [
          ...
          { term: 'Tone', def: 'The feeling conveyed by your word choices â€” formal vs informal' },
        ...
        timing: {
          ...
          teach: { mins: 10, points: [
            'Email structure: subject line, greeting, body (context â†’ request â†’ thank you), sign-off',
            'Subject lines: specific and useful ("RE: History homework â€” extension request" not "hi")',
          ...
          create: { mins: 40, task: 'Part 1: Students receive a badly written email and must rewrite it professionally (template provided). Part 2: Compose an original email to a fictional employer requesting work experience, with a CV attached (use a template). Part 3: Open a shared Word Online document, leave two constructive comments and one suggestion using Suggesting mode.', tools: ['Outlook', 'Word Online'] },
        ...
        aiAngle: 'AI can draft emails â€” but you need to know what a good email looks like to judge whether the AI got it right.',
        tools: [
...

  {
    ...
    colour: '#7c3aed', emoji: 'ðŸ¤–',
    lessons: [
      {
        id: 'df-8-4', year: 8, lessonNum: 4, unitNum: 2,
        title: 'Hello AI', subtitle: 'Meet your AI assistant â€” and its limits',
        emoji: 'ðŸ‘‹', colour: '#7c3aed',
        ...
        timing: {
          hook: { mins: 5, activity: 'Teacher asks an AI a question live â€” one where it gets something confidently wrong (e.g. a local fact). Class erupts. "This is your new tool. Let\'s learn to use it properly."' },
          teach: { mins: 12, points: [
            'What generative AI is: predicting likely next words from training data',
            'ChatGPT, Copilot, Copilot â€” same idea, different companies',
          ...
          create: { mins: 38, task: 'Structured exploration: Students use Copilot (school-safe) to complete 4 mini-challenges. (1) Ask it to explain a topic they find confusing in school. Rate the explanation 1-5. (2) Ask it to write a poem about their hobby â€” edit it to make it actually theirs. (3) Ask it a local fact they know the answer to â€” catch it if it\'s wrong. (4) Ask it to help plan a birthday party â€” note what\'s useful and what\'s wrong. Document everything in their "AI Log" (template provided).', tools: ['Microsoft Copilot', 'AI Log template (Word Online document)'] },
          share: { mins: 5, activity: 'Share the best "AI got it wrong" moment. Build a class list of things AI is bad at.' },
        },
        aiAngle: 'This IS the AI lesson â€” foundation for all future AI work.',
        tools: [
        ...
        differentiation: {
          support: 'Pre-written prompts on a card â€” students just need to run them and evaluate',
          extension: 'Research how a large language model works. Draw a diagram explaining it to a Year 7 student.',
        },
        teacherNote: 'Use school-approved AI tools only. Check your school policy before this lesson. If ChatGPT isn\'t approved, Microsoft Copilot is generally school-safe. Do not skip the safety rules â€” they matter.',
      },
      {
        id: 'df-8-5', year: 8, lessonNum: 5, unitNum: 2,
        title: 'Prompt Powerup', subtitle: 'Better prompts = better results',
        emoji: 'âš¡', colour: '#7c3aed',
        ...
        vocab: [
          ...
          { term: 'Iteration', def: 'Improving through repeated attempts â€” each prompt builds on the last' },
        ...
        aiAngle: 'Core AI skill â€” this lesson alone changes how students use AI forever.',
      ...
      },
      {
        ...
        vocab: [
          { term: 'Hallucination', def: 'AI confidently stating something false â€” not lying, just wrong prediction' },
        ...
        timing: {
          hook: { mins: 5, activity: 'Teacher has planted 5 "AI fact cards" around the room â€” some true, some hallucinated. Students read and vote true/false. Reveal.' },
          teach: { mins: 10, points: [
          ...
          create: { mins: 40, task: 'Students are given a topic related to another subject (e.g. the causes of WW1, climate change facts, a historical person). They must: (1) Get an AI summary on the topic. (2) Fact-check every single claim â€” mark correct (âœ“), wrong (âœ—), or can\'t verify (?). (3) Find reliable sources for at least 3 claims. (4) Write an improved, verified paragraph. Document in "Fact-Check Worksheet".', tools: ['Microsoft Copilot', 'Bing', 'BBC / gov.uk', 'Fact-Check Worksheet'] },
          share: { mins: 5, activity: 'What was the most surprising wrong thing AI said? Build a hall-of-shame list.' },
        },
        aiAngle: 'Critical AI evaluation â€” the most important skill for AI use.',
        tools: [
          { name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', free: true },
        ...
        differentiation: {
          support: 'Pre-highlighted AI text â€” students only need to check the underlined claims',
      ...
      },
      {
        ...
        title: 'AI + My Work', subtitle: 'Use AI to improve your work â€” not replace it',
        emoji: 'âœï¸', colour: '#7c3aed',
        ...
        timing: {
          hook: { mins: 5, activity: 'Scenario: A student submits work AI wrote word-for-word. Another uses AI to get feedback, then rewrites it themselves. Who should get the credit? Class debate â€” 2 minutes.' },
          teach: { mins: 10, points: [
          ...
          create: { mins: 40, task: 'Students take a piece of writing they\'ve done recently (any subject â€” their own words). (1) Ask AI for feedback using a structured prompt ("Act as a GCSE English teacher â€” give me 3 specific improvements for this paragraph..."). (2) Read the feedback critically â€” is it useful? Is anything wrong? (3) Rewrite the paragraph using the useful feedback. (4) Write their AI use statement. Compare before/after.', tools: ['Microsoft Copilot', 'Word Online'] },
          share: { mins: 5, activity: 'Show before and after â€” who made the biggest genuine improvement? Celebrate the human work, not the AI output.' },
        },
        aiAngle: 'The culmination of Unit B â€” AI as a tool for human growth.',
        tools: [{ name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', free: true }],
        ...
        differentiation: {
          support: 'Pre-written prompts for the feedback conversation â€” students just paste their text',
...

  {
    ...
    colour: '#ff6b6b', emoji: 'ðŸŽ¨',
    lessons: [
      {
        id: 'df-8-8', year: 8, lessonNum: 8, unitNum: 3,
        title: 'Design Basics', subtitle: 'Canva, design principles and your first poster',
        emoji: 'ðŸ–¼ï¸', colour: '#ff6b6b',
        bigIdea: 'Good design isn\'t about talent â€” it\'s about knowing the rules.',
        objectives: [
        ...
        timing: {
          hook: { mins: 5, activity: 'Show 3 pairs of posters â€” one designed well, one badly. Students vote and explain why in one word. Reveal the design principles that explain each choice.' },
          teach: { mins: 10, points: [
            'CRAP: Contrast, Repetition, Alignment, Proximity â€” the four laws of design',
            'Typography: max 2 fonts, one for headings one for body',
            'Colour: 60-30-10 rule (dominant, secondary, accent)',
            'Whitespace is your friend â€” don\'t fill every gap',
            'Canva tour: templates, elements, text, image upload, brand kit, export',
          ]},
          create: { mins: 40, task: 'Create a poster for a school digital wellbeing campaign ("Think Before You Post" or "Screen Smart" â€” student chooses). Must use CRAP principles, maximum 2 fonts, limited colour palette. Use Canva. Export as PDF and PNG. Write 3 sentences explaining their design choices.', tools: ['Canva'] },
        ...
        aiAngle: 'Canva has AI image generation and design suggestion tools â€” explore them but always make the final creative decisions yourself.',
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Speaker notes', def: 'Prompts for the presenter â€” never read these aloud' },
          { term: 'Slide economy', def: 'Using only as many slides and words as necessary' },
          { term: 'Audience', def: 'Who you\'re communicating to â€” it changes every design decision' },
        ],
        timing: {
          ...
          teach: { mins: 10, points: [
            'One idea, one slide â€” ruthless editing',
          ...
          share: { mins: 5, activity: 'Quick fire â€” each student has 30 seconds to present their opening slide only. Peer votes: clear? Visual? Would you want to see the rest?' },
        },
        aiAngle: 'Use AI to generate speaker notes and suggest one key statistic or image idea per slide â€” but design the slides yourself.',
        tools: [
        ...
        differentiation: {
          support: 'Slide skeleton with layout guides pre-set â€” students fill in the visual content',
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Cell reference', def: 'The address of a cell, e.g. B3 â€” used in formulas' },
          { term: 'Function', def: 'A pre-built formula like SUM() or AVERAGE()' },
          { term: 'Chart', def: 'A visual representation of data â€” type matters' },
        ],
        timing: {
          hook: { mins: 5, activity: '"Would you rather earn Â£50,000 as a flat salary, or start at Â£30,000 with a 5% raise each year?" Students guess â€” then teacher shows a spreadsheet model that answers it definitively.' },
          teach: { mins: 10, points: [
            'Spreadsheet grid: rows, columns, cells â€” the foundation',
            'Data types: text vs numbers â€” formulas only work on numbers',
            'Key formulas: =SUM(), =AVERAGE(), =MIN(), =MAX(), =COUNT()',
            'Cell references: why B3+C3 is better than 5+7',
            'Charts: bar chart (comparing categories), line chart (change over time), pie chart (proportions â€” use sparingly)',
          ]},
        ...
        aiAngle: 'Ask AI to explain what a formula does, suggest a formula for a task, or explain why a chart might be misleading â€” then verify it actually works.',
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Copyright', def: 'Legal protection for creators â€” using without permission can be illegal' },
          { term: 'Attribution', def: 'Crediting where an image or text came from' },
          { term: 'Public domain', def: 'Work with no copyright restrictions â€” free to use' },
        ],
        timing: {
          hook: { mins: 5, activity: '"Find me a photo of the Prime Minister in 30 seconds â€” but only one you can legally use in a school poster." Students scramble. Most get it wrong. Reveal the correct approach.' },
          teach: { mins: 10, points: [
          ...
          create: { mins: 40, task: 'Students receive a research brief about a current technology issue (e.g. AI in healthcare, electric vehicles, social media and mental health). They must: (1) Find 3 sources using SIFT and rate each for credibility. (2) Find 2 legally usable images with correct attribution. (3) Summarise their findings in a structured Word Online with sources cited. (4) Add their CC-attributed images with captions.', tools: ['Bing', 'Unsplash', 'Pexels', 'Word Online'] },
          share: { mins: 5, activity: 'Quick share: what was the most suspicious source you found? What gave it away?' },
        },
        aiAngle: 'AI can\'t tell you if images are copyright-free. Always check manually. AI outputs also don\'t have reliable sources â€” they need to be verified using SIFT.',
        tools: [
          { name: 'Unsplash', url: 'https://unsplash.com', free: true },
        ...
        differentiation: {
          support: 'Pre-selected sources â€” students evaluate rather than find',
    ...
    lessons: [
      {
        ...
        vocab: [
          ...
          { term: 'MFA / 2FA', def: 'Multi-factor authentication â€” a second check beyond the password' },
        ...
        timing: {
          ...
          teach: { mins: 10, points: [
            'Password strength: length beats complexity â€” 4 random words = very strong',
        ...
        aiAngle: 'AI is increasingly used to make phishing emails more convincing â€” grammatically perfect, personalised. The red flags are getting harder to spot.',
        tools: [
      ...
      },
      {
        ...
        title: 'Your Digital Footprint', subtitle: 'Your online identity â€” who sees it, forever',
        emoji: 'ðŸ‘£', colour: '#f59e0b',
        ...
        vocab: [
          ...
          { term: 'Reputation', def: 'How others perceive you â€” increasingly shaped by your online presence' },
        ...
        timing: {
          ...
          create: { mins: 40, task: 'Part 1: Scenario cards â€” groups evaluate 10 online behaviours and rank them risk level 1-5 with justification. Part 2: Students design a "Digital Identity Guide" aimed at a Year 7 student starting secondary school â€” in PowerPoint Online, Canva or as a document. It must include: 3 do\'s, 3 don\'ts, what a digital footprint is, and one piece of advice they wish they\'d known.', tools: ['Canva', 'PowerPoint Online'] },
          share: { mins: 5, activity: 'Share one genuine piece of advice. Compile into a class "Digital Survival Guide" shared document.' },
        },
        aiAngle: 'AI tools also collect your data. Be aware of what you share in prompts â€” don\'t include personal details, medical info or anything private.',
        ...
        homework: { task: 'Search your own name. What appears? Write 3 sentences: what you found, whether it represents you well, and what you\'d want to change.', mins: 15 },
        differentiation: {
      ...
      },
      {
        ...
        emoji: 'ðŸ“°', colour: '#f59e0b',
        bigIdea: 'The internet shows you what keeps you scrolling â€” not necessarily what\'s true.',
        objectives: [
        ...
        timing: {
          hook: { mins: 5, activity: 'Show 3 viral social media posts â€” one true, one false, one satire. Students vote on each. Most get at least one wrong. Why?' },
          teach: { mins: 10, points: [
            ...
            'SIFT: Stop â†’ Investigate â†’ Find better coverage â†’ Trace claims',
          ]},
          create: { mins: 40, task: 'Fact-checking newsroom: students are editors at a fictional fact-checking agency. They receive 8 claims (supplied â€” mix of real viral posts and fabricated ones). For each: classify (true/false/misleading/satire), apply SIFT, write a one-sentence verdict with evidence. Then create a short "How to Spot Fake News" Instagram-style carousel (3 slides in Canva).', tools: ['Bing', 'Full Fact (fullfact.org)', 'Canva'] },
    ...
    lessons: [
      {
        ...
        vocab: [
          ...
          { term: 'Audience', def: 'Who the product is for â€” determines every design decision' },
        ...
        timing: {
          ...
          teach: { mins: 10, points: [
            ...
            'Project planning: brief analysis â†’ success criteria â†’ asset list â†’ timeline',
            'Time management: 2 build lessons = 80 minutes â€” plan carefully',
          ]},
          create: { mins: 40, task: 'Students choose their project and complete a project plan template: (1) Brief summary in their own words. (2) Target audience (specific â€” not just "everyone"). (3) Success criteria (5 specific, measurable statements). (4) Asset list â€” what do they need to make/find before starting? (5) Two-session timeline â€” what will they complete in each session? Teacher approves the plan before they proceed.', tools: ['Word Online'] },
          share: { mins: 5, activity: 'Each student pitches their project in 30 seconds: what, who for, and why they chose it.' },
        },
        aiAngle: 'Use AI to help refine your brief â€” ask it "What would make this project excellent? What am I missing from my success criteria?"',
        ...
        differentiation: {
          ...
          extension: 'Add a 30-second "pitch video" to their deliverables â€” record a video explaining the project',
        },
        teacherNote: 'Don\'t let students start building in this lesson â€” the plan must be solid first. Approve every plan before Lesson 16.',
      },
      {
        id: 'df-8-16', year: 8, lessonNum: 16, unitNum: 5,
        title: 'Build Day', subtitle: 'Create your final project',
        emoji: 'ðŸ”¨', colour: '#10b981',
        ...
        aiAngle: 'AI may be used for feedback, improving drafts, and generating ideas â€” but every word in the final product should be written or edited by the student.',
        tools: [
          { name: 'Canva', url: 'https://canva.com/education', free: true },
          { name: 'Microsoft 365', url: 'https://microsoft365.com', free: true },
        ],
        ...
        differentiation: {
          ...
          extension: 'Add a reflective "Designer\'s Commentary" â€” a short paragraph explaining each major design/content decision',
        },
      },
      {
        ...
        emoji: 'ðŸŽ‰', colour: '#10b981',
        bigIdea: 'Sharing your work is the final step â€” and the most important.',
        objectives: [
        ...
        timing: {
          hook: { mins: 5, activity: 'Open with the baseline skills audit from Lesson 1. Students rate themselves again on each skill â€” they\'ll be amazed at the progress.' },
          teach: { mins: 5, points: [
        ...
        homework: { task: 'No homework â€” celebrate! Optional: share your favourite project with a family member and teach them one thing you learned this year.', mins: 0 },
        differentiation: {
          support: 'Simplified self-evaluation with sentence starters',
          extension: 'Write a "Letter to my Year 9 self" â€” what to focus on, what they\'ve learned, what excites them about Y9 Digital Futures',
        },
    ...
    lessons: [
      {
        ...
        vocab: [
          ...
          { term: 'Temperature', def: 'How creative/random vs. focused an AI\'s output is â€” a setting you can control' },
          { term: 'Training data', def: 'The massive corpus of text used to train the model â€” full of human biases' },
          { term: 'Context window', def: 'How much text an AI can "see" at once â€” like working memory' },
        ],
        timing: {
          ...
          teach: { mins: 15, points: [
            ...
            'Training data problems: internet text is not balanced â€” skews toward English, Western, male',
            ...
            'Multimodal AI: text, image, audio, video â€” all converging',
          ]},
          create: { mins: 35, task: 'Investigation task: students run a set of structured experiments to observe AI behaviour. (1) Test temperature by asking the same question multiple times â€” is it consistent? (2) Find an example of AI reproducing a cultural or gender bias. (3) Test the context window by giving a very long context and seeing if AI remembers detail from the start. (4) Find a task where AI fails completely â€” and write a hypothesis for WHY. Document with screenshots in a "How AI Works" investigation report.', tools: ['Microsoft Copilot', 'Word Online'] },
          share: { mins: 5, activity: 'What surprised you most? What would you want AI developers to fix?' },
        },
        aiAngle: 'This IS the AI lesson â€” building the critical literacy foundation for all Year 9 AI work.',
        tools: [{ name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', free: true }],
      ...
      },
      {
        ...
        timing: {
          hook: { mins: 5, activity: 'Show the average job listing for "AI Prompt Engineer" â€” Â£60-120k salary. "This job didn\'t exist 3 years ago. Today you\'ll start learning it."' },
          teach: { mins: 12, points: [
            'Review RCTF (Year 8) â€” now going deeper',
          ...
          create: { mins: 38, task: 'Masterclass challenge â€” 3 advanced tasks: (1) Use role prompting to get a genuinely expert-level explanation of a topic they\'re studying (cross-subject). (2) Use chain-of-thought to solve a logic puzzle step by step. (3) Use few-shot to get AI to write in their own writing style (give it 3 examples of their writing, then ask it to continue in the same style). Evaluate each output using the "output quality rubric" provided. Record all prompts and outputs.', tools: ['Microsoft Copilot', 'AI Log (continued)'] },
        ...
        aiAngle: 'Core AI skills lesson â€” this will change how students use AI in every subject.',
        tools: [{ name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', free: true }],
        ...
        differentiation: {
          support: 'Prompt templates pre-written â€” students modify one element at a time',
          extension: 'Research "prompt injection attacks" â€” how can malicious prompts hijack AI systems? Write a short security brief.',
        },
      },
      {
        id: 'df-9-3', year: 9, lessonNum: 3, unitNum: 1,
        title: 'Deepfakes & Disinformation', subtitle: 'Detecting AI-generated content',
        emoji: 'ðŸŽ­', colour: '#7c3aed',
        ...
        timing: {
          hook: { mins: 5, activity: 'Show 4 images â€” 2 real, 2 AI-generated. Students vote. Reveal. Then explain how you can tell. The tells are getting much harder to spot.' },
          teach: { mins: 12, points: [
            ...
            'Verification tools: Bing Image Search, TinEye, Hive Moderation, InVID',
          ]},
          create: { mins: 38, task: 'Deepfake detection lab: students receive a pack of 12 images/short clips (pre-curated mix of real and AI-generated). For each: classify (real/fake), identify 2 specific tells, and record confidence (1-10). Then cross-check using Bing Image Search or TinEye. Final task: write a 200-word "Media Verification Guide" for a school newspaper editor â€” what checks to run before publishing any submitted image.', tools: ['Bing Image Search', 'TinEye', 'InVID WeVerify', 'Word Online'] },
          share: { mins: 5, activity: 'Which image fooled the most people? What made it convincing?' },
        },
        aiAngle: 'AI is creating the problem â€” and AI is also part of the detection solution. But humans must remain the final check.',
        tools: [
          { name: 'Bing Image Search', url: 'https://www.bing.com/images', free: true },
        ...
        differentiation: {
          support: 'Images pre-labelled with one confirmed tell â€” students find the second',
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Accountability', def: 'The principle that someone must be responsible for outcomes â€” including AI outcomes' },
        ...
        timing: {
          ...
          teach: { mins: 12, points: [
            'AI and jobs: tasks automated vs. roles created â€” not just "jobs taken"',
          ...
          create: { mins: 38, task: 'Oxford-style debate: class divided into 3 teams arguing different positions on the motion "AI will make the world fairer for everyone." Each team researches, prepares a 3-minute opening argument, then responds to the others. Followed by written individual task: 250-word structured response to "Should the UK government slow down AI development to protect workers? Justify your position with evidence."', tools: ['Word Online', 'Bing', 'BBC / Guardian'] },
    ...
    lessons: [
      {
        ...
        vocab: [
          { term: 'Absolute reference', def: 'A cell address that doesn\'t change when copied â€” uses $ sign (e.g. $B$2)' },
        ...
        timing: {
          ...
          create: { mins: 38, task: 'Build a "Real World Model" â€” students choose from: (A) School Tuck Shop Profit Calculator: items, cost price, sell price, profit per item, total profit with a target profit cell (absolute ref). (B) Savings Goal Tracker: monthly income, savings %, months to reach goal (absolute ref for percentage). (C) Sports League Table: wins/draws/losses â†’ points, conditional format top 3. Full IF statements and absolute references must be demonstrated.', tools: ['Excel Online'] },
          share: { mins: 5, activity: 'Demo challenge: teacher changes one input cell in each student\'s model â€” does it update correctly everywhere? Instant quality check.' },
        },
        aiAngle: 'Use AI to explain a formula you don\'t understand â€” but test it before trusting it. AI often hallucinates Excel Online formula syntax.',
        tools: [{ name: 'Excel Online', url: 'https://office.com', free: true }],
        ...
        differentiation: {
          support: 'Skeleton model with structure ready â€” students complete the formulas',
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Truncated axis', def: 'A chart axis that doesn\'t start at zero â€” can make differences look bigger' },
        ],
        timing: {
          hook: { mins: 5, activity: 'Show two charts of the same data â€” one with a y-axis starting at 0, one starting at a higher number to make a small change look dramatic. "This is used in politics, business and advertising every day."' },
          teach: { mins: 12, points: [
        ...
        aiAngle: 'Use AI to suggest what type of chart is most appropriate for your data, or to write the interpretation paragraph â€” then verify the chart choice is correct.',
        tools: [{ name: 'Excel Online', url: 'https://office.com', free: true }],
        ...
        differentiation: {
          support: 'Dashboard layout template pre-built â€” students add charts and formatting',
          extension: 'Use Microsoft Power BI (free) to build an interactive dashboard from the same data.',
        },
      },
      {
        id: 'df-9-7', year: 9, lessonNum: 7, unitNum: 2,
        title: 'Algorithm Watch', subtitle: 'How platforms shape what you see â€” and think',
        emoji: 'ðŸŒ€', colour: '#00d4ff',
        bigIdea: 'Platforms don\'t show you reality â€” they show you a curated version designed to keep you scrolling.',
        objectives: [
        ...
        vocab: [
          ...
          { term: 'Engagement', def: 'Interactions (clicks, likes, watch time) â€” what platforms are optimised to maximise' },
        ...
        differentiation: {
          ...
          extension: 'Research the Digital Services Act (EU) or Online Safety Act (UK) â€” what rules exist about dark patterns? Are they working?',
        },
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        title: 'Brand Identity', subtitle: 'Logo, colour, typography â€” build a visual system',
        emoji: 'ðŸŽ¨', colour: '#ff6b6b',
        ...
        vocab: [
          ...
          { term: 'Colour psychology', def: 'How colours create emotional associations â€” e.g. blue = trust, red = energy' },
          ...
          { term: 'Vector graphic', def: 'An image defined by mathematical paths â€” scalable without quality loss' },
        ],
        timing: {
        ...
        aiAngle: 'Use Canva\'s AI features to explore colour combinations and suggest brand concepts â€” but the final design decisions must be yours and justified.',
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Rule of thirds', def: 'A composition guideline â€” place subjects along the grid lines, not dead centre' },
          { term: 'B-roll', def: 'Supplementary footage shown while someone is speaking' },
          { term: 'Captions', def: 'Text showing what is being said â€” essential for accessibility' },
        ...
        timing: {
          ...
          teach: { mins: 12, points: [
            ...
            'Audio: the most common mistake â€” bad audio destroys good video',
        ...
        aiAngle: 'AI tools can generate automatic captions (Clipchamp, CapCut) â€” but always review them, they make mistakes. AI can also generate B-roll images.',
        tools: [
        ...
        teacherNote: 'Book phones/tablets for recording. Students can use school devices or personal phones (check policy). Ensure you have a quiet space for recording â€” even a corridor works.',
      },
      {
        id: 'df-9-10', year: 9, lessonNum: 10, unitNum: 3,
        title: 'Campaign Design', subtitle: 'Multi-platform digital campaign for a real cause',
        emoji: 'ðŸ“¢', colour: '#ff6b6b',
        ...
        timing: {
          ...
          teach: { mins: 12, points: [
            'Campaign planning: problem â†’ audience â†’ message â†’ format â†’ CTA â†’ measure',
        ...
        aiAngle: 'Use AI to generate campaign slogans and test different message angles â€” then pick the best one and make it your own.',
        tools: [{ name: 'Canva', url: 'https://canva.com/education', free: true }],
        ...
        differentiation: {
          support: 'Campaign brief pre-written â€” students choose the formats and create assets',
      ...
      },
      {
        ...
        emoji: 'â™¿', colour: '#ff6b6b',
        bigIdea: '1 in 5 people in the UK have a disability. Design that excludes them isn\'t just unfair â€” it\'s bad design.',
        objectives: [
        ...
        vocab: [
          { term: 'WCAG', def: 'Web Content Accessibility Guidelines â€” the international standard for digital accessibility' },
          { term: 'Alt text', def: 'A written description of an image for screen reader users' },
          { term: 'Contrast ratio', def: 'The difference in brightness between text and background â€” must meet minimum standards' },
          { term: 'Screen reader', def: 'Software that reads digital content aloud for visually impaired users' },
          { term: 'Cognitive load', def: 'How much mental effort something requires â€” good design minimises this' },
        ],
        timing: {
          ...
          teach: { mins: 12, points: [
            ...
            'Alt text: describe the meaning, not just the appearance â€” "A bar chart showing..." not "image"',
            'Headings: they\'re not just visual â€” screen readers navigate by them',
        ...
        aiAngle: 'AI tools are getting better at generating alt text automatically â€” but they still make mistakes. Always review AI-generated alt text for accuracy.',
        tools: [
        ...
        differentiation: {
          support: 'Checklist broken into "quick wins" vs "more complex" â€” support students focus on quick wins first',
          extension: 'Create an "Accessibility First Design Guide" â€” a one-page reference for students creating digital work.',
        },
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        vocab: [
          ...
          { term: 'Zero-day vulnerability', def: 'A security flaw unknown to the developer â€” no patch exists yet' },
          { term: 'Penetration testing', def: 'Authorised hacking to find vulnerabilities before criminals do' },
        ],
        timing: {
          hook: { mins: 5, activity: 'Show a real UK cyber attack case study (e.g. WannaCry NHS attack 2017 â€” public info). What failed? What was the human element? What did it cost?' },
          teach: { mins: 12, points: [
            'Attack types: phishing, malware, ransomware, man-in-the-middle, credential stuffing',
            'Most attacks exploit people, not just technology â€” social engineering',
            'The cyber kill chain: reconnaissance â†’ delivery â†’ exploitation â†’ persistence',
            ...
            'Cyber careers: ethical hacker, security analyst, pen tester â€” all in demand',
          ]},
          create: { mins: 38, task: 'Students receive a fictional profile of a teenager\'s digital life (named accounts, devices, habits, passwords). Task: produce a full "Cybersecurity Risk Assessment" â€” for each risk area (accounts, devices, networks, social media, physical), rate likelihood (1-5) and impact (1-5), giving a risk score. Then produce a "Top 5 Recommendations" report with justification. Finally, write a 100-word cover note for the fictional "client" explaining the most urgent action.', tools: ['Word Online', 'Excel Online'] },
          share: { mins: 5, activity: 'What was the #1 risk? Was it the same for everyone? Which recommendation would be hardest to follow â€” and why?' },
        },
      ...
      },
      {
        ...
        vocab: [
          ...
          { term: 'Action item', def: 'A specific task assigned to a specific person with a deadline â€” from a meeting' },
        ],
        timing: {
          ...
          teach: { mins: 12, points: [
            'Microsoft 365 / Microsoft 365 as professional tools',
            ...
            'LinkedIn basics: professional digital identity â€” what Year 10+ students should think about',
          ]},
          create: { mins: 38, task: 'Mock workplace simulation: students work in teams of 3-4 as "Digital Futures project teams." (1) Create a shared Outlook Calendar with a 2-week project timeline. (2) Run a 5-minute team "meeting" and take minutes using a template (chair, note-taker, action items). (3) Write a professional project update email to the "teacher as client." (4) Create a shared task list in Microsoft To Do or Sheets with owner and deadline for each item.', tools: ['Outlook Calendar', 'Word Online', 'Excel Online', 'Outlook'] },
          share: { mins: 5, activity: 'Review: which team produced the most professional meeting minutes? What made them effective?' },
        },
        aiAngle: 'AI tools like Microsoft Copilot can take meeting notes, draft emails and summarise long documents â€” but the professional judgement of what to communicate still requires you.',
        tools: [
          { name: 'Outlook Calendar', url: 'https://outlook.live.com/calendar', free: true },
          { name: 'Microsoft 365', url: 'https://microsoft365.com', free: true },
        ],
    ...
    lessons: [
      {
        ...
        vocab: [
          ...
          { term: 'Scope', def: 'The boundaries of a project â€” what is and isn\'t included' },
          { term: 'Milestone', def: 'A significant checkpoint in a project timeline' },
          { term: 'Risk', def: 'A potential problem that could affect the project â€” planned for in advance' },
        ],
        timing: {
          ...
          teach: { mins: 10, points: [
            'Year 9 project options: (A) AI Ethics Magazine â€” 4-page digital magazine on an AI issue. (B) Digital Wellbeing Campaign â€” full campaign pack (brand, video, social assets, report). (C) Data Investigation â€” spreadsheet analysis of a real dataset + dashboard + written findings. (D) Tech Explainer Series â€” 3 Ã— 60-second videos on AI topics for younger students.',
            'Planning: brief â†’ audience â†’ success criteria â†’ scope â†’ asset list â†’ risks â†’ timeline',
          ...
          create: { mins: 40, task: 'Students choose their project and produce a professional project specification (template provided): brief analysis, audience profile, 6 success criteria, scope statement (in/out), asset list, risk register (3 risks with mitigations), and a 2-session timeline. Then use AI to critique their plan â€” document the conversation and note what they changed as a result. Teacher approves all plans before Lesson 15.', tools: ['Word Online', 'Microsoft Copilot'] },
        ...
        aiAngle: 'AI is explicitly used as a planning partner â€” but students must document what changed and why, demonstrating they\'re still in charge.',
        tools: [
          { name: 'Word Online', url: 'https://office.com', free: true },
          { name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', free: true },
        ],
        ...
        differentiation: {
          ...
          extension: 'Include a "post-launch plan" â€” if this were a real product, how would you promote it and measure success?',
        },
        teacherNote: 'Approve every plan rigorously â€” the most common failure mode is over-ambitious scope. Help students cut down rather than scale up.',
      },
      {
        ...
        aiAngle: 'AI use must be fully documented â€” what was asked, what was produced, what the student changed. This is practice for professional AI use norms.',
        tools: [
          { name: 'Canva', url: 'https://canva.com/education', free: true },
          { name: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', free: true },
          { name: 'CapCut', url: 'https://capcut.com', free: true },
        ...
        differentiation: {
          ...
          extension: 'Create a "making of" slide â€” how was the project built? What tools were used? What challenges were overcome?',
        },
      },
      {
        ...
        timing: {
          ...
          teach: { mins: 5, points: [
            ...
            'Looking ahead: digital skills are in every career â€” every NHS job, every law firm, every creative studio',
          ]},
          create: { mins: 35, task: 'Portfolio showcase: students display final projects (screen or printed). Class gallery walk with sticky note feedback (physical or Padlet). Then structured self-evaluation: across 2 years, rate yourself 1-5 on each of the 8 digital literacy strands from the curriculum. Pick your top 3 most-improved skills and write one sentence of evidence for each. Complete the "Letter to my GCSE self" â€” 3 digital skills to develop in Year 10 and why.', tools: ['Padlet', 'Microsoft Forms'] },
          share: { mins: 15, activity: 'Teacher celebration: award recognitions â€” most creative, most improved, most technically impressive, most socially useful, most professionally presented. Every student receives something genuine. End with: "You are more digitally capable than most adults you know. Use it well."' },
        },
        ...
        differentiation: {
          ...
          extension: 'Create a "Digital Futures highlight reel" â€” a 60-second video showcasing their best work from across the 2 years, with narration.',
        },
