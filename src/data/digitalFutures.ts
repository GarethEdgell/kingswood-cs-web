...

  {
    ...
    lessons: [
      ...
      },
      {
        ...
        timing: {
          hook: { mins: 5, activity: '"Has anyone ever lost a piece of homework?" Show a dramatic story of a student losing a whole essay. Then show version history saving the day — teacher demo on a Word Online.' },
          teach: { mins: 10, points: [
      ...
      },
      {
        ...
        timing: {
          ...
          create: { mins: 40, task: 'Part 1: Students receive a badly written email and must rewrite it professionally (template provided). Part 2: Compose an original email to a fictional employer requesting work experience, with a CV attached (use a template). Part 3: Open a shared Word Online, leave two constructive comments and one suggestion using Suggesting mode.', tools: ['Outlook', 'Word Online'] },
    ...
    lessons: [
      {
        ...
        timing: {
          ...
          create: { mins: 38, task: 'Structured exploration via the Teacher AI Station (Year 8 students are under 13, so AI is teacher-mediated — students write prompts and submit them; the teacher runs the class\'s prompts through the AI and returns the responses to evaluate). Four mini-challenges, written up in the "AI Log" (template provided): (1) Write a prompt asking it to explain a topic they find confusing in school — rate the returned explanation 1-5. (2) Ask it to write a poem about their hobby — then edit the returned poem to make it actually theirs. (3) Ask a local fact they know the answer to — catch it if the response is wrong. (4) Ask it to help plan a birthday party — note what\'s useful and what\'s wrong. Students submit prompts through the lesson assignment and never use a live AI directly.', tools: ['Teacher AI Station (submission)', 'AI Log (Word Online)'] },
          share: { mins: 5, activity: 'Share the best "AI got it wrong" moment. Build a class list of things AI is bad at.' },
        },
        aiAngle: 'This IS the AI lesson — the foundation for all future AI work. Because Year 8 students are under 13, every interaction is teacher-mediated: students write prompts, the teacher runs them through the AI, and students evaluate the responses. You learn everything about using AI without ever using a live AI service yourself.',
        tools: [
          { name: 'Teacher AI Station (via your assignment)', url: '/dashboard', free: true },
          { name: 'AI Log Template', url: '', free: true },
        ],
        evidence: 'Completed AI Log with 4 mini-challenges and honest evaluations',
        homework: { task: 'Plan a prompt you would use to help you revise for one upcoming test. Write an "AI use statement": what would you ask, what might be useful, what would you need to check or change?', mins: 20 },
        differentiation: {
        ...
        teacherNote: 'Year 8 students are under 13 and must NOT use live AI tools directly. This lesson uses the Teacher AI Station: create an "AI Task" assignment for your class (Teacher dashboard → class → New assignment), students submit their prompts, and you batch-run them through the AI with "Run all pending through AI". You may also demonstrate AI live on the projector. Do not skip the safety rules — they matter.',
      },
      {
        ...
        timing: {
          ...
          create: { mins: 40, task: 'Prompt challenge tournament (teacher-mediated — under-13 safe): students write the best possible prompt for each of 5 tasks and submit them through the lesson\'s Teacher AI Station. The teacher runs the prompts and returns the outputs; students evaluate each (1-5 stars with a reason), then iterate once by submitting an improved prompt. Tasks: (1) Help me understand photosynthesis, (2) Give me 10 ideas for a school campaign poster, (3) Check my argument in this paragraph [their own writing], (4) Create 5 quiz questions on the Roman Empire, (5) Help me plan my revision timetable. Record all prompts and returned outputs in their AI Log.', tools: ['Teacher AI Station (submission)', 'AI Log'] },
        ...
        aiAngle: 'Core AI skill — this lesson alone changes how students use AI forever. All prompts are run by the teacher via the Teacher AI Station, so under-13 students learn prompt engineering without using a live AI service themselves.',
        tools: [{ name: 'Teacher AI Station (via your assignment)', url: '/dashboard', free: true }],
        evidence: 'AI Log with 5 prompt/output/evaluation/iteration cycles',
        homework: { task: 'Write 3 RCTF prompts for something useful in your life (homework help, meal ideas, career research). For each, predict what a strong response would include and note how you would improve the prompt. You can run them at the Teacher AI Station next lesson.', mins: 20 },
        differentiation: {
      ...
      },
      {
        ...
        timing: {
          ...
          create: { mins: 40, task: 'Students are given a topic related to another subject (e.g. the causes of WW1, climate change facts, a historical person). They must: (1) Submit a prompt asking for an AI summary of the topic via the Teacher AI Station — the teacher runs it and returns the AI\'s response (under-13 safe; no live AI use). (2) Fact-check every single claim in the returned summary — mark correct (✓), wrong (✗), or can\'t verify (?). (3) Find reliable sources for at least 3 claims. (4) Write an improved, verified paragraph. Document in "Fact-Check Worksheet".', tools: ['Teacher AI Station (submission)', 'Bing', 'BBC / gov.uk', 'Fact-Check Worksheet'] },
          share: { mins: 5, activity: 'What was the most surprising wrong thing AI said? Build a hall-of-shame list.' },
        },
        aiAngle: 'Critical AI evaluation — the most important skill for AI use. AI summaries are run by the teacher via the Teacher AI Station and returned for students to fact-check, so under-13 students practise scrutinising AI output without using a live AI service.',
        tools: [
          { name: 'Teacher AI Station (via your assignment)', url: '/dashboard', free: true },
        ...
        homework: { task: 'Choose something you\'re studying in another subject and write the prompt you would give an AI about it. Research the topic using a reliable source and list 3 specific claims you would fact-check if an AI answered. Write a short note on how you would verify each.', mins: 20 },
        differentiation: {
      ...
      },
      {
        ...
        timing: {
          ...
          create: { mins: 40, task: 'Students take a piece of writing they\'ve done recently (any subject — their own words). (1) Submit their work AND a structured feedback prompt ("Act as a GCSE English teacher — give me 3 specific improvements for this paragraph…") through the lesson\'s AI Task assignment. The teacher clicks "Run all pending through AI" and the AI feedback is returned to each student (under-13 safe — students never call a live AI). (2) Read the returned feedback critically — is it useful? Is anything wrong? (3) Rewrite the paragraph themselves using the useful feedback. (4) Write their AI use statement. Compare before/after.', tools: ['Teacher AI Station (AI Task assignment)', 'Word Online'] },
        ...
        aiAngle: 'The culmination of Unit B — AI as a tool for human growth, used safely through the teacher. Students submit their work and a feedback prompt; the teacher batch-runs them through the AI and returns feedback to each student. No under-13 student ever touches a live AI service.',
        tools: [{ name: 'Teacher AI Station (AI Task assignment)', url: '/dashboard', free: true }],
        evidence: 'Before/after writing comparison + AI use statement',
        homework: { task: 'Draft a feedback prompt and choose a piece of your own work to improve for another subject. Write the AI use statement you would attach. Bring both to next lesson to submit at the Teacher AI Station.', mins: 20 },
        differentiation: {
        ...
        teacherNote: 'Set this up as an "AI Task" assignment (Teacher dashboard → class → New assignment → AI Task). Students submit their work and prompt; click "Run all pending through AI" to return feedback to the whole class at once. Works best if students bring actual homework from another subject — coordinate with form tutors or other departments if possible.',
      },
    ],
  },
